...
expirydate = datetime.date(2022, 1, 26)
...
def hero():
    ...
    y=1
    newperiod=period
    banner='figlet GENMALL|lolcat'
    numbers=[]
    while(y):
        clear()
        system(banner)
        print(f"{red}Contact me on telegram @ra_hu7")
...
if(expirydate>today):
    ...
    if (now>Third and now<Thirdend):
        ...
        print("26th jan 2022, 12:00 PM- 04:30 PM")
        #print("31st Aug 2021, 08:00 PM- 08:30 PM")
        print("Please play on the given time, and ")
        print("If you think it is an error contact")
        print(" admin on telegram @ra_hu7 ")
    ...
    print(" on telegram ----@ra_hu7 for activating")
    ...
    while(True):
        print("My banking name is MR RAHUL")
        ...
        print(f"If It Does'nt Open Contact Me On Telegram {yellow}@ra_hu7")
        print(f"{neon}*---------*----------*-------------*----------*")
        print(f"{red}*---------*----------*-------------*----------*")
        print("payhere--- UPI : ")
        print(f"{yellow}UPI1 : rahul.132@ybl")
        print("UPI2 : mrahul16@fbl")
        ...
        if(bhai==code):
            ...
            print(f"{neon}On Telegram {red}@ra_hu7")
            print("wait.... starting....")
            time.sleep(20)
            period=rava
            hero()
            #print("Today Server is off GENMALL try tomorrow ")
